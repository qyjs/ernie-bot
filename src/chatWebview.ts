  ...
  resolveWebviewView(webviewView: WebviewView): void | Thenable<void> {
    ...
    <body>
      ...
      window.addEventListener('message', event => {
        ...
        <div class="outer">
           <iframe id='WebviewIframe' class="webView_iframe" sandbox="allow-scripts allow-same-origin allow-forms allow-pointer-lock allow-downloads" allow="cross-origin-isolated; clipboard-read; clipboard-write;" src="http://localhost:4200/"></iframe>
        </div>
    </body>
    </html>
    `;
